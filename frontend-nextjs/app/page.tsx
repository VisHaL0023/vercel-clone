    ...
    return (
        <main className="flex justify-center items-center h-[100vh]">
            <div className="w-[600px]">
                <div className="flex flex-col mb-5 gap-1 items-center justify-center">
                    <p className="text-4xl">Vercel Clone</p>
                    <p>Upload only React and Javascript based project</p>
                </div>
                ...
                {deployPreviewURL && (
                    <div className="mt-2 bg-slate-900 py-4 px-2 rounded-lg">
                        {isDone ? (
                            ...
                            <p>
                                Please wait while we deploying your project...
                            </p>
                        )}
                    </div>
                )}
